  ...
  <main>
    ...
    <section id="comments" class="container mx-auto mt-6">
      <div class="relative flex flex-col bg-white border border-gray-200 rounded">
        ...
        <div class="p-6">
          <div v-if="comment_show_alert" class="p-4 mb-4 font-bold text-center text-white" :class="comment_alert_variant">
    ...
    <ul class="container mx-auto">
      <li v-for="comment in sortedComments" :key="comment.docID" class="p-6 border border-gray-200 bg-gray-50">
        <!-- Comment Author -->
        <div class="mb-5">
